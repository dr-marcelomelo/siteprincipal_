      ...
      >
        <div className={cn(
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            ...
            {/* Mobile Menu & CTA */}
            <div className="bg-neutral-darkGray group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-gold-medium/20 p-6 shadow-2xl shadow-black/80 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
...
const Footer = () => {
  ...
  return (
    <footer className="bg-neutral-darkGray text-white pt-10 pb-6 md:pt-16 md:pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
          {/* Brand */}
          <div>
            <div className="mb-4 md:mb-6 flex items-center gap-3">
              <img src={LogoIcon} alt="Logo Ícone" className="h-8 md:h-14 w-auto object-contain" />
              <img src={LogoName} alt="Dr. Marcelo Melo" className="h-6 md:h-10 w-auto object-contain mt-2" />
            </div>
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed mb-6">
              Compromisso, ética e dedicação para resolver seus problemas jurídicos com humanidade e eficiência.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-gold-medium transition-colors"><Instagram size={18} className="md:w-5 md:h-5" /></a>
              <a href="#" className="text-gray-400 hover:text-gold-medium transition-colors"><Mail size={18} className="md:w-5 md:h-5" /></a>
            </div>
          </div>

          {/* Links */}
          <div>
            <h3 className="font-serif text-base md:text-xl text-gold-light mb-3 md:mb-6">Links Rápidos</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-serif text-base md:text-xl text-gold-light mb-3 md:mb-6">Contato</h3>
            <ul className="space-y-3 md:space-y-4 text-gray-300 text-xs md:text-sm">
              <li className="flex items-start">
                <MapPin className="text-gold-medium mr-3 mt-1 flex-shrink-0" size={16} />
                <span>AV MARIO YPIRANGA 1521,<br />Manaus - AM</span>
              </li>
              <li className="flex items-center">
                <Clock className="text-gold-medium mr-3 flex-shrink-0" size={16} />
                <span>Seg à Sex: 08:00 às 20:00</span>
              </li>
              <li className="flex items-center">
                <Phone className="text-gold-medium mr-3 flex-shrink-0" size={16} />
                <span>(92) 98468-8656</span>
              </li>
              <li className="flex items-center">
                <Mail className="text-gold-medium mr-3 flex-shrink-0" size={16} />
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-gray-500 text-[10px] md:text-xs">&copy; {new Date().getFullYear()} Dr. Marcelo Melo Advocacia. Todos os direitos reservados.</p>
