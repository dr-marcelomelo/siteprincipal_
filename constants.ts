...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    text: "Fui demitido injustamente e não sabia o que fazer. Dr. Marcelo lutou pelos meus direitos e conseguiu todas as verbas rescisórias que eu tinha direito. Profissional excepcional!"
  },
  {
    ...
    text: "Comprei um produto com defeito e a loja se recusava a trocar. O escritório entrou com ação e consegui não só a troca como também indenização por danos morais. Muito obrigada!"
  },
  {
    ...
    avatar: "RA",
    text: "Precisava de ajuda com uma questão de pensão alimentícia. Dr. Marcelo foi muito humano e profissional, resolveu meu caso com rapidez e justiça."
  },
  {
    ...
    avatar: "JF",
    text: "Estava com problemas no meu auxílio-doença do INSS. O Dr. Marcelo foi super atencioso, explicou cada etapa e conseguiu reverter a negativa. Recomendo de olhos fechados!"
  },
  {
    ...
    service: "Direito do Consumidor",
    avatar: "MV",
    text: "Tive uma experiência péssima com uma operadora de telefonia. O escritório me ajudou a processar e ganhei a causa. Atendimento nota 10!"
  }
];
